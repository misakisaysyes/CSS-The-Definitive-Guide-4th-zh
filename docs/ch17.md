...
In CSS, transitions are written using four transition properties: transitionproperty, transition-duration, transition-timing-function, and transitiondelay, along with the transition property as a shorthand for the four longhand properties.
